...
const char * host = "169.234.113.174";
const char server[] = "169.234.113.174";
...
void setup()
{
  ...
  for(ppgnum = 0; ppgnum < 3000; ppgnum++)
  {
     _IR[ppgnum] = particleSensor.getIR();  //this function takes 20ms
     //_RED[ppgnum] = particleSensor.getRed(); //this function takes 20ms
     //delay(20);
  }
...
/**********************************************************************
 * Method 1: take all the sets of data and post to the server together
 **********************************************************************/
void loop()
...
/**********************************************************************
 * Method 2: post data to server right after every timr after read one 
 * set of data
 **********************************************************************
void loop()
